         ...
         <span className=" text-center text-2xl font-semibold text-sky-600 px-2">Cabinet Medical</span> </h1>
                ...
                <p className="p-2 text-center px-12">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                 Facere, vitae quas? Repellendus odio, 
                        ...
                        <div className=" rounded-sm w-1/2 space-x-5 space-y-1 flex items-center justify-between bg-white  border border-gray-800 p-1">
                      {  /*<button  className=" bg-sky-600 hover:bg-sky-700 text-white rounded-full  p-2  sm:px-5 "
                        ...
                        onClick={()=>{navigate('/doctors')}}>Doctor's</button>**/}
                        <div className="flex border-e border-gray-800">
                        ...
                        <button className="w-[50px] h-full bg-gray-800 text-white p-1 rounded-e-full ">Done</button>
