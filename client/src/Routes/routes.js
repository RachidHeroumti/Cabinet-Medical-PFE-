...
export const getDepartmetRoute=`${host}/departments/get-deps`;


export const addRDVRoute=`${host}/rdvs/Add-rdv`;
//export const getRDVsRoute=`${host}/rdv/Add-rdv`;
export const getPatientRDVRoute=`${host}/rdvs/get-Myrdvs`;
export const getdocRDVRoute=`${host}/rdvs/get-rdvsDoc`;
export const deletRDVRoute=`${host}/rdvs/delete-rdv`
